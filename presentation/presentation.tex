	...
	\begin{figure}[]
		...
		\end{minipage}
			\begin{minipage}[c][0.33\paperheight][c]{\linewidth}
				...
				\hfill
				\only<1-2>{\begin{minipage}{0.18\linewidth}
						\resizebox{\linewidth}{!}{\begin{minipage}{2.9\textwidth}
								\begin{multline*}
									\frac{\partial \rho (z,r,\phi; t)}{\partial t} \\
									 + \nabla \cdot \rho (z,r,\phi; t)\mathbf{u}(z,r,\phi; t) = 0 
								\end{multline*}
						\end{minipage}}
						\hfill
						\resizebox{\linewidth}{!}{\begin{minipage}{2.9\textwidth}
								\begin{multline*}
									\frac{\partial \mathbf{u}(z,r,\phi; t)}{\partial t} \\
									+ \left( \mathbf{u}(z,r,\phi; t) \cdot \nabla \right) \mathbf{u}(z,r,\phi; t) \\ 
									- \frac{\mu}{\rho(z,r,\phi; t)} \nabla^2 \mathbf{u}(z,r,\phi; t) = \\
				...
				\end{minipage}}
				\only<3->{\begin{minipage}{0.18\linewidth}
						\resizebox{\linewidth}{!}{\begin{minipage}{1.9\textwidth}
								\begin{equation*}
						...
						\resizebox{\linewidth}{!}{\begin{minipage}{1.9\textwidth}
								\begin{multline*}
									\frac{\partial Q}{\partial t} + \frac{\partial}{\partial z}\left(\frac{Q^2}{A} \right) \\
									+ \frac{A}{\rho} \frac{\partial P}{\partial z} = -22 \frac{\mu}{\rho} \frac{Q}{A}.
								\end{multline*}
						\end{minipage}}
				\end{minipage}}
				\hfill
