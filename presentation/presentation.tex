...
\begin{frame}
	...
	\begin{minipage}[t][0.41\paperheight][t]{\textwidth}
		\begin{block}{Model Based Approach}
			use models that are parametrized to represent a specific patient and simulate biomarkers that have a strong correlation with the occurrence or the outcome of a disease through first principles 
		\end{block}
	\end{minipage}
	\begin{minipage}[t][0.41\paperheight][t]{\textwidth}
	\end{minipage}
...
\begin{frame}
	...
	\end{minipage} \hfill
	\begin{minipage}{0.39\textwidth}
	\begin{minipage}[t][0.51\paperheight][t]{\textwidth}
		\begin{block}{Model Based Approach}
			use models that are parametrized to represent a specific patient and simulate biomarkers that have a strong correlation with the occurrence or the outcome of a disease through first principles 
		\end{block}
	\end{minipage}
	\begin{minipage}[t][0.31\paperheight][t]{\textwidth}
		\begin{block}{Example}
			$\hookrightarrow$
		\end{block}
	\end{minipage}
