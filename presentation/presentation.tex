...
\begin{frame}
	...
	\begin{frame}
		\frametitle{Parameter Inference Pipeline}
		$\vcenter{\hbox{\includegraphics[angle=270,origin=c,width=0.1\textwidth]{images/left_turn_arrow.eps}}}$
		$\vcenter{	\hbox{\begin{varwidth}{0.6\textwidth} 
					Parameter Inference: \begin{itemize} 
					...
					\end{itemize} 
		\end{varwidth}}}$
		$\vcenter{\hbox{\includegraphics[angle=180,origin=c,width=0.1\textwidth]{images/left_turn_arrow.eps}}}$
		\vfill
		$\vcenter{\hbox{\includegraphics[width=0.2\textwidth]{images/bifurcation.eps}}}$
		$\vcenter{\hbox{\includegraphics[width=0.1\textwidth]{images/right_arrow.png}}}$ 
		$\vcenter{	\hbox{\begin{varwidth}{0.21\textwidth} 
