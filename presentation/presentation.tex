...
\begin{frame}
	...
	\begin{itemize}
		...
		\item heavily studied but currently no perfect solution 
			...
			\end{tabular}
		\item
			$\Rightarrow$ accurately determining the absolute vascular pressure through a computational model would allow reliable prediction of HPD while avoiding the risk of an invasive procedure
...
\begin{frame}
	...
	$\vcenter{\hbox{\includegraphics[width=0.1\textwidth]{images/right_arrow.png}}}$
	$\vcenter{\vfil \hbox to 0.2\textwidth {Medical Imaging}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\vfil \hbox to 0.2\textwidth {Extract 3D Geometry}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\vfil \hbox to 0.2\textwidth {}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\hbox{\includegraphics[width=0.2\textwidth]{images/bifurcation.eps}}}$
	$\vcenter{\hbox{\includegraphics[width=0.1\textwidth]{images/right_arrow.png}}}$ 
	$\vcenter{	\hbox{\begin{varwidth}{0.2\textwidth} 
	...
	$\vcenter{\vfil \hbox to 0.2\textwidth {Set Parameters}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\vfil \hbox to 0.2\textwidth {Solve}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\vfil \hbox to 0.2\textwidth {Biomarkers}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
\end{frame}
\begin{frame}
	...
	$\vcenter{\vfil \hbox to 0.2\textwidth {Extract 3D Geometry}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\vfil \hbox to 0.2\textwidth {Extract 1D Geometry}}$
	$\vcenter{\vfil \hbox to 0.1\textwidth {}}$
	$\vcenter{\hbox{\includegraphics[width=0.2\textwidth]{images/bifurcation.eps}}}$
	$\vcenter{\hbox{\includegraphics[width=0.1\textwidth]{images/right_arrow.png}}}$ 
	$\vcenter{	\hbox{\begin{varwidth}{0.2\textwidth} 
