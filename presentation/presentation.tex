		...
		\end{minipage}
			\begin{minipage}[c][0.33\paperheight][c]{\linewidth}
				\begin{minipage}{0.18\linewidth}
						...
						\includegraphics<3->[width=\linewidth]{images/bifurcation_1D.eps}%
			\end{minipage}
				\hfill
				\begin{minipage}{0.1\linewidth}
					\includegraphics[width=\linewidth]{images/right_arrow.png}
				...
				\hfill
				%\begin{minipage}{0.18\linewidth}
				%	\includegraphics<1-2>[width=\linewidth]{images/solver_3D.eps}%
				%	\includegraphics<3->[width=\linewidth]{images/solver_1D.eps}%
				%\end{minipage}
				%\only<1-2>{\begin{minipage}{0.18\linewidth}
